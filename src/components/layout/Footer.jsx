  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-28 border border-white/5 bg-white/[0.02] backdrop-blur-sm p-12 lg:p-16">
          ...
          <form className="flex flex-col sm:flex-row max-w-lg mx-auto gap-4" onSubmit={handleSubscribe}>
            <input 
              ...
              className="flex-1 bg-transparent border-b border-white/20 px-4 py-3 text-text-primary placeholder:text-text-muted focus:outline-none focus:border-gold transition-colors duration-300 rounded-none font-light disabled:opacity-50"
              required
            />
            <button 
              type="submit"
              disabled={status !== 'idle'}
              className="bg-gold text-primary-dark uppercase tracking-[0.2em] text-xs px-8 py-3 font-medium hover:bg-white hover:text-primary transition-all duration-300 flex items-center justify-center group min-w-[150px] disabled:opacity-90 disabled:cursor-not-allowed"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 gap-x-8 mb-20 lg:mb-28">
          ...
          <div className="md:col-span-4 lg:col-span-2 text-center lg:text-left">
            ...
            <ul className="space-y-4 text-sm text-text-secondary font-light">
              <li>
                <Link to="/expeditions" className="hover:text-gold transition-colors duration-300 relative group inline-block">
                  Our Expeditions
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-gold transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </li>
              <li>
                <Link to="/private-jets" className="hover:text-gold transition-colors duration-300 relative group inline-block">
                  Private Aviation
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-gold transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </li>
              <li>
                <Link to="/journal" className="hover:text-gold transition-colors duration-300 relative group inline-block">
                  The Journal
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-gold transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </li>
          ...
          <div className="md:col-span-4 lg:col-span-2 text-center lg:text-left">
            ...
            <ul className="space-y-4 text-sm text-text-secondary font-light">
              <li>
                <Link to="/contact" className="hover:text-gold transition-colors duration-300 relative group inline-block">
                  Concierge
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-gold transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </li>
              <li>
                <Link to="/faq" className="hover:text-gold transition-colors duration-300 relative group inline-block">
                  FAQ
                  <span className="absolute -bottom-1 left-0 w-0 h-px bg-gold transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </li>
        ...
        {/* Bottom Strip */}
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center relative gap-8 text-center md:text-left">
          ...
          <div className="space-x-8 text-xs text-text-muted font-light tracking-[0.1em] opacity-80 flex items-center justify-center">
            ...
            <Link to="/terms" className="hover:text-gold transition-colors duration-300">Terms</Link>
          </div>
