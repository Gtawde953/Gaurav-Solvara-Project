      ...
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <section className="mb-20">
          ...
          <motion.div 
            ...
            className="border border-gold/30 bg-primary overflow-hidden group"
          >
            <div className="flex flex-col lg:flex-row">
              <div className="lg:w-1/3 h-64 lg:h-auto overflow-hidden relative">
                <img 
                  src="https://images.unsplash.com/photo-1547471080-7cb2ac647a52?q=80&w=2670&auto=format&fit=crop" 
                  alt="Serengeti" 
