            ...
            <form className="glass-panel p-8 md:p-12 space-y-8 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                <div className="space-y-2">
                  ...
                  <input type="text" className="w-full bg-transparent border-b border-white/20 text-text-primary py-2 px-0 focus:outline-none focus:border-gold transition-colors text-sm" placeholder="e.g. James" />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-text-muted">Last Name</label>
                  <input type="text" className="w-full bg-transparent border-b border-white/20 text-text-primary py-2 px-0 focus:outline-none focus:border-gold transition-colors text-sm" placeholder="e.g. Bond" />
                </div>
              </div>

              <div className="space-y-2 relative z-10">
                <label className="text-[10px] uppercase tracking-widest text-text-muted">Email Address</label>
                <input type="email" className="w-full bg-transparent border-b border-white/20 text-text-primary py-2 px-0 focus:outline-none focus:border-gold transition-colors text-sm" placeholder="james@example.com" />
              </div>

              <div className="space-y-2 relative z-10">
                <label className="text-[10px] uppercase tracking-widest text-text-muted">Nature of Inquiry</label>
                <select className="w-full bg-transparent border-b border-white/20 text-text-primary py-2 px-0 focus:outline-none focus:border-gold transition-colors text-sm appearance-none">
              ...
              <div className="space-y-2 relative z-10">
                ...
                <textarea 
                  className="w-full bg-transparent border-b border-white/20 text-text-primary py-2 px-0 focus:outline-none focus:border-gold transition-colors text-sm resize-none" 
                  rows="4" 
