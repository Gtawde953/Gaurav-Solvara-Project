            ...
            <AnimatePresence mode="wait">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {expeditions.map(exp => (
                      <div 
                        ...
                        className={`cursor-pointer p-6 border transition-all duration-300 relative overflow-hidden group
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {['June 2026', 'July 2026', 'August 2026', 'September 2026', 'October 2026', 'November 2026', 'December 2026'].map(month => (
                        <button
                          ...
                          className={`py-4 text-sm tracking-wide transition-all duration-300 border
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div 
                        ...
                        className={`cursor-pointer p-8 border transition-all duration-300 flex items-center justify-between
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {fleet.map(jet => (
                      <div 
                        ...
                        className={`cursor-pointer border transition-all duration-300 group
              ...
              {currentStep === 4 && (
                <motion.div key="step5" variants={slideUp} initial="hidden" animate="visible" exit="exit" className="space-y-8 text-center py-10">
                  ...
                  <div className="p-6 border border-white/10 bg-primary inline-block text-left max-w-md w-full">
                    <h4 className="text-gold tracking-widest text-xs uppercase mb-4">Concierge Note</h4>
                    <textarea 
                      className="w-full bg-transparent border-b border-white/20 text-text-primary p-2 placeholder-text-muted text-sm focus:outline-none focus:border-gold resize-none" 
                      rows="3" 
