...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-serif text-text-primary mb-8"
          >
          ...
          >
            <Button to="/expeditions" size="lg">Plan Your Safari</Button>
            <Button to="/journal" variant="outline" size="lg">Explore Journal</Button>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-primary px-6 border-y border-white/5">
      ...
      {/* Private Jet Teaser */}
      <section className="py-32 relative overflow-hidden flex items-center justify-center px-6">
        ...
        <div className="relative z-20 container mx-auto text-center max-w-3xl">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
      ...
      {/* Testimonials */}
      <section className="py-32 px-6 bg-primary-dark">
      ...
      {/* Final CTA */}
      <section className="py-24 border-t border-white/5 bg-[#0e0e0e] text-center px-6">
        <motion.div
           initial={{ opacity: 0, y: 20 }}
           whileInView={{ opacity: 1, y: 0 }}
           viewport={{ once: true }}
